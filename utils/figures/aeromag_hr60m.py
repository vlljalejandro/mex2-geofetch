...
def build_rtp_preview():
    ...
    # Diverging colormap centered on zero — standard for RTP magnetic data
    ...
    cbar.set_label("Reduced-to-Pole Magnetic Field (nT)", fontsize=8)
    ...
    ax.set_title("High-Resolution Aeromagnetic RTP", fontsize=13, fontweight="bold")
